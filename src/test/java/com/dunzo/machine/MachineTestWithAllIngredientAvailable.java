...
public class MachineTestWithAllIngredientAvailable {
    ...
    @Test
    public void testMachineWithIngredientAvailable() {
        ...
        recipeHotCoffee.addIngredients("sugar_syrup", 30);
        ...
        recipeBlackTea.addIngredients("hot_water", 100);
        ...
        recipeGreenTea.addIngredients("tea_leaves_syrup", 10);
        recipeGreenTea.addIngredients("ginger_syrup", 30);
        recipeGreenTea.addIngredients("sugar_syrup", 10);
        beverages.addRecipe("green_tea", recipeGreenTea);

        machine.startMachine(beverages, n);

        // Out content should be empty as all the ingredients should be processed
        assert (DispenserRunnable.getBeverageCountPrepared().equals(4));
